...
export const TableActionSchema = Schema.Union(Schema.Literal('join'), Schema.Literal('leave'));
...
export const PlayerEventSchema = Schema.Union(MoveEventSchema, TableEventSchema);
...
export const GameEventSchema = Schema.Union(PlayerEventSchema, SystemEventSchema);
